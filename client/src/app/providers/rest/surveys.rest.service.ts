...
export class SurveysService {
  ...
  public filter(params){
    let headers = new Headers();
      ...
      return this.http.get(Constants.API_URL +  '/filtersurveys' + strParams, options)
      .map(res => res.json());
  ...
  public find(params){
    let headers = new Headers();
      ...
      return this.http.get(Constants.API_URL +  '/surveys' + strParams, options)
      .map(res => res.json());
      //.catch(error => Observable.throw(error))
      //.subscribe(data => this.success(data), error => console.log(error));
  }

  public getDBChart(params){
    let headers = new Headers();
			//console.log(formData);
			headers.append('Content-Type', 'application/json');
			headers.append('Accept', 'application/json');
      ...
      return this.http.get(Constants.API_URL +  '/dbchart' + strParams, options)
      .map(res => res.json());
      //.catch(error => Observable.throw(error))
      //.subscribe(data => this.success(data), error => console.log(error));
  }
  ...
  save(params){
      ...
      let headers = new Headers();
			...
			headers.append('Accept', 'application/json');
      let options = new RequestOptions({ headers: headers });
      return this.http.post(Constants.API_URL + '/surveys', params, options)
      .map(res => res.json());
      //.catch(error => Observable.throw(error))
      //.subscribe(data => this.success(data), error => console.log(error));
  }
