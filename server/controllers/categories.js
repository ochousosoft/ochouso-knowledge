...
exports.find.path = '/server/api/categories';
...
exports.findOne.path = '/server/api/category';
...
exports.save.path = '/server/api/categories';
...
exports.saveOne.path = '/server/api/category';
...
exports.delete.path = '/server/api/category';
