...
var model = require('../models/Device');
...
exports.find.path = '/server/api/devices';
...
exports.findOne.path = '/server/api/device';
...
exports.save.path = '/server/api/devices';
...
exports.saveOne.path = '/server/api/device';
...
exports.delete.path = '/server/api/device';
